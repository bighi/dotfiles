...
plugins=(git asdf history-substring-search zoxide)
...
# misc aliases
# alias gcal="gcalcli"
# alias clima="weather sbrj -m | grep -Pzo '(Heat|Sky) .*' | cowsay -w"
alias hosts="cat /etc/hosts"
alias q="q -H -d ,"
alias xclipin="xclip -in -selection clipboard"
alias xclipout="xclip -out -selection clipboard"
alias subl="subliminal download -l pt-BR -s"
